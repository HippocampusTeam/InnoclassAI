...
static int __pyx_f_4main_test(int, int __pyx_skip_dispatch); /*proto*/
...
static PyObject *__pyx_pf_4main_test(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_x); /* proto */
/* Late includes */
...
static PyObject *__pyx_pw_4main_1test(PyObject *__pyx_self, PyObject *__pyx_arg_x); /*proto*/
static int __pyx_f_4main_test(int __pyx_v_x, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_y;
  int __pyx_v_i;
  int __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_4main_1test(PyObject *__pyx_self, PyObject *__pyx_arg_x); /*proto*/
static PyObject *__pyx_pw_4main_1test(PyObject *__pyx_self, PyObject *__pyx_arg_x) {
  int __pyx_v_x;
  int __pyx_lineno = 0;
  ...
  __pyx_r = __pyx_pf_4main_test(__pyx_self, ((int)__pyx_v_x));
...
static PyObject *__pyx_pf_4main_test(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_x) {
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_f_4main_test(__pyx_v_x, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1, __pyx_L1_error)
...
static PyMethodDef __pyx_methods[] = {
  {"test", (PyCFunction)__pyx_pw_4main_1test, METH_O, 0},
  {0, 0, 0, 0}
};
