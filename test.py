...
calculate_msg = 'Что-то не так с вычислением вывода нейронной сети (функция calculate). Убедитесь, '
'что: веса последнего слоя выставляются правильно, вы используете функцию '
'аактивации, вы правильно вычисляете значения ВСЕХ нейронов, вы не забываете '
'умножать на веса и не перепутали индексы нейронов'
