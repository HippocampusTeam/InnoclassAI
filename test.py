...
class TestCalculator(unittest.TestCase):
    ...
    def test_set_weights1(self):
        ...
        self.assertEqual(self.network.set_weights(2, [2, 1, 3, 2, 1, 2, 3, 4, 5]), output,
    ...
    def test_set_weights2(self):
        ...
        self.assertEqual(self.network.set_weights(1,
    ...
    def test_calculate1(self):
        self.network.set_weights(2, [2, 1, 3, 2, 1, 2, 3, 4, 5])
        self.network.set_biases(1, [3, -2, 5])
        eps = 1e-3
        output = self.network.calculate([6, 3, 4.6, 5.7, 0])
    ...
    def test_calculate3(self):
        self.network.set_weights(1,
            [0.546, -4, 355678875865, 4, 678, 5, 345.76867, 6, 7, 8, -325.6, 6456.7, 4, 7, 87])
        self.network.set_biases(0, [56, 34, 67., 34., 908])
        self.network.set_weights(2, [8, 9.96, -3, 0.062, -0.7, 82, 63, -4, -58])
        self.network.set_biases(1, [0.3, -2, 51])
        eps = 1e-3
        output = self.network.calculate([6, 3, 4.6, 5.7, 0])
